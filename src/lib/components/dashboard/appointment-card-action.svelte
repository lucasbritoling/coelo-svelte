	...
	<DropdownMenu.Content align="end" class="min-w-48">
		...
		>
			...
			<button
				type="submit"
				disabled={isDeleting}
				class="flex w-full rounded-lg items-center gap-2 px-2 py-1.5 text-sm text-destructive transition-colors outline-none hover:bg-destructive/10 disabled:opacity-50"
			>
				{#if isDeleting}
